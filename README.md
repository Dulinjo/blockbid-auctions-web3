...
- `ENABLE_OPENAI_LEGAL_INTAKE=true`
- `ENABLE_E_SERVICES_GUIDE=true`
- `ENABLE_ADMIN_SERVICE_KB=true`
- `ENABLE_ENVELOPE_CLUES=true`
- `ENABLE_DRAFT_ESERVICES_IN_DEV=true`
- `LEGAL_INTAKE_MODEL=gpt-4o-mini` (opciono, OpenAI intake model)

Feedback / survey kontrola:

- `FREE_QUERIES_BEFORE_MINI_FEEDBACK=2`
- `FREE_QUERIES_BEFORE_SURVEY_POPUP=4`
- `EXTRA_QUERIES_AFTER_MINI_FEEDBACK=3`
- `EXTRA_QUERIES_AFTER_FULL_SURVEY=10`
- `ALLOW_SKIP_SURVEY=true`
- `MAX_SKIPS_BEFORE_SOFT_BLOCK=2`
